...
//   className="flex justify-start items-start w-1/2"
// >
//   <img
//     src={phone}
...
//   className="flex flex-col justify-center items-start w-1/2 ps-[8%] mt-4"
// >
...
//   <form onSubmit={formik.handleSubmit} className="flex flex-col space-y-4 w-[55%] mt-6">
//     {/* Name Input */}
...
//         className="w-full py-3 px-4 border-b-2 border-zinc-400 focus:outline-none focus:border-blue-600 dark:focus:border-blue-400 
//                   dark:bg-gray-900 dark:placeholder-gray-400 placeholder-gray-600 rounded-lg transition-transform duration-300 transform hover:scale-[102%] focus:scale-[104%]"
//       />
