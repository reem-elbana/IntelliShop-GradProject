...
//         className="flex flex-col justify-center items-start w-1/2 ps-[8%]"
//       >
//         <h1 className="text-2xl font-semibold">Login To Intellishop</h1>
//         <h3 className="pt-3">Enter your details below</h3>
...
//             <a
//               href="#"
//               className="font-medium hover:text-red-800 transition duration-300 text-md text-red-600 ps-14 pt-3 dark:text-red-600 dark:hover:text-red-800 sm:mb-0 mb-2"
//             >
